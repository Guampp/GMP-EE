...
public class GMPJTabbedPaneBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( comps.tabbedpane.GMPJTabbedPane.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", comps.tabbedpane.GMPJTabbedPane.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", comps.tabbedpane.GMPJTabbedPane.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", comps.tabbedpane.GMPJTabbedPane.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", comps.tabbedpane.GMPJTabbedPane.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", comps.tabbedpane.GMPJTabbedPane.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", comps.tabbedpane.GMPJTabbedPane.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", comps.tabbedpane.GMPJTabbedPane.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundAt] = new IndexedPropertyDescriptor ( "backgroundAt", comps.tabbedpane.GMPJTabbedPane.class, null, null, "getBackgroundAt", "setBackgroundAt" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", comps.tabbedpane.GMPJTabbedPane.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", comps.tabbedpane.GMPJTabbedPane.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", comps.tabbedpane.GMPJTabbedPane.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", comps.tabbedpane.GMPJTabbedPane.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_boundsAt] = new IndexedPropertyDescriptor ( "boundsAt", comps.tabbedpane.GMPJTabbedPane.class, null, null, "getBoundsAt", null ); // NOI18N
            properties[PROPERTY_changeListeners] = new PropertyDescriptor ( "changeListeners", comps.tabbedpane.GMPJTabbedPane.class, "getChangeListeners", null ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", comps.tabbedpane.GMPJTabbedPane.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", comps.tabbedpane.GMPJTabbedPane.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentAt] = new IndexedPropertyDescriptor ( "componentAt", comps.tabbedpane.GMPJTabbedPane.class, null, null, "getComponentAt", "setComponentAt" ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", comps.tabbedpane.GMPJTabbedPane.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", comps.tabbedpane.GMPJTabbedPane.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", comps.tabbedpane.GMPJTabbedPane.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", comps.tabbedpane.GMPJTabbedPane.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", comps.tabbedpane.GMPJTabbedPane.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", comps.tabbedpane.GMPJTabbedPane.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", comps.tabbedpane.GMPJTabbedPane.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", comps.tabbedpane.GMPJTabbedPane.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", comps.tabbedpane.GMPJTabbedPane.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_disabledIconAt] = new IndexedPropertyDescriptor ( "disabledIconAt", comps.tabbedpane.GMPJTabbedPane.class, null, null, "getDisabledIconAt", "setDisabledIconAt" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", comps.tabbedpane.GMPJTabbedPane.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_displayedMnemonicIndexAt] = new IndexedPropertyDescriptor ( "displayedMnemonicIndexAt", comps.tabbedpane.GMPJTabbedPane.class, null, null, "getDisplayedMnemonicIndexAt", "setDisplayedMnemonicIndexAt" ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", comps.tabbedpane.GMPJTabbedPane.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", comps.tabbedpane.GMPJTabbedPane.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", comps.tabbedpane.GMPJTabbedPane.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_enabledAt] = new IndexedPropertyDescriptor ( "enabledAt", comps.tabbedpane.GMPJTabbedPane.class, null, null, "isEnabledAt", "setEnabledAt" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", comps.tabbedpane.GMPJTabbedPane.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", comps.tabbedpane.GMPJTabbedPane.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", comps.tabbedpane.GMPJTabbedPane.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", comps.tabbedpane.GMPJTabbedPane.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", comps.tabbedpane.GMPJTabbedPane.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", comps.tabbedpane.GMPJTabbedPane.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", comps.tabbedpane.GMPJTabbedPane.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", comps.tabbedpane.GMPJTabbedPane.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", comps.tabbedpane.GMPJTabbedPane.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", comps.tabbedpane.GMPJTabbedPane.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", comps.tabbedpane.GMPJTabbedPane.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", comps.tabbedpane.GMPJTabbedPane.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", comps.tabbedpane.GMPJTabbedPane.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", comps.tabbedpane.GMPJTabbedPane.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundAt] = new IndexedPropertyDescriptor ( "foregroundAt", comps.tabbedpane.GMPJTabbedPane.class, null, null, "getForegroundAt", "setForegroundAt" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", comps.tabbedpane.GMPJTabbedPane.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", comps.tabbedpane.GMPJTabbedPane.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", comps.tabbedpane.GMPJTabbedPane.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", comps.tabbedpane.GMPJTabbedPane.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", comps.tabbedpane.GMPJTabbedPane.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", comps.tabbedpane.GMPJTabbedPane.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_iconAt] = new IndexedPropertyDescriptor ( "iconAt", comps.tabbedpane.GMPJTabbedPane.class, null, null, "getIconAt", "setIconAt" ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", comps.tabbedpane.GMPJTabbedPane.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", comps.tabbedpane.GMPJTabbedPane.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", comps.tabbedpane.GMPJTabbedPane.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", comps.tabbedpane.GMPJTabbedPane.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", comps.tabbedpane.GMPJTabbedPane.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", comps.tabbedpane.GMPJTabbedPane.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", comps.tabbedpane.GMPJTabbedPane.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", comps.tabbedpane.GMPJTabbedPane.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", comps.tabbedpane.GMPJTabbedPane.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", comps.tabbedpane.GMPJTabbedPane.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", comps.tabbedpane.GMPJTabbedPane.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", comps.tabbedpane.GMPJTabbedPane.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", comps.tabbedpane.GMPJTabbedPane.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", comps.tabbedpane.GMPJTabbedPane.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_locked] = new PropertyDescriptor ( "locked", comps.tabbedpane.GMPJTabbedPane.class, null, "setLocked" ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", comps.tabbedpane.GMPJTabbedPane.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", comps.tabbedpane.GMPJTabbedPane.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", comps.tabbedpane.GMPJTabbedPane.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", comps.tabbedpane.GMPJTabbedPane.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", comps.tabbedpane.GMPJTabbedPane.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mnemonicAt] = new IndexedPropertyDescriptor ( "mnemonicAt", comps.tabbedpane.GMPJTabbedPane.class, null, null, "getMnemonicAt", "setMnemonicAt" ); // NOI18N
            properties[PROPERTY_model] = new PropertyDescriptor ( "model", comps.tabbedpane.GMPJTabbedPane.class, "getModel", "setModel" ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", comps.tabbedpane.GMPJTabbedPane.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", comps.tabbedpane.GMPJTabbedPane.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", comps.tabbedpane.GMPJTabbedPane.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", comps.tabbedpane.GMPJTabbedPane.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", comps.tabbedpane.GMPJTabbedPane.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", comps.tabbedpane.GMPJTabbedPane.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", comps.tabbedpane.GMPJTabbedPane.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", comps.tabbedpane.GMPJTabbedPane.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", comps.tabbedpane.GMPJTabbedPane.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", comps.tabbedpane.GMPJTabbedPane.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", comps.tabbedpane.GMPJTabbedPane.class, "getParent", null ); // NOI18N
            properties[PROPERTY_peer] = new PropertyDescriptor ( "peer", comps.tabbedpane.GMPJTabbedPane.class, "getPeer", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", comps.tabbedpane.GMPJTabbedPane.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", comps.tabbedpane.GMPJTabbedPane.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", comps.tabbedpane.GMPJTabbedPane.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", comps.tabbedpane.GMPJTabbedPane.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", comps.tabbedpane.GMPJTabbedPane.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", comps.tabbedpane.GMPJTabbedPane.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_selectedComponent] = new PropertyDescriptor ( "selectedComponent", comps.tabbedpane.GMPJTabbedPane.class, "getSelectedComponent", "setSelectedComponent" ); // NOI18N
            properties[PROPERTY_selectedIndex] = new PropertyDescriptor ( "selectedIndex", comps.tabbedpane.GMPJTabbedPane.class, "getSelectedIndex", "setSelectedIndex" ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", comps.tabbedpane.GMPJTabbedPane.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", comps.tabbedpane.GMPJTabbedPane.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_tabComponentAt] = new IndexedPropertyDescriptor ( "tabComponentAt", comps.tabbedpane.GMPJTabbedPane.class, null, null, "getTabComponentAt", "setTabComponentAt" ); // NOI18N
            properties[PROPERTY_tabCount] = new PropertyDescriptor ( "tabCount", comps.tabbedpane.GMPJTabbedPane.class, "getTabCount", null ); // NOI18N
            properties[PROPERTY_tabLayoutPolicy] = new PropertyDescriptor ( "tabLayoutPolicy", comps.tabbedpane.GMPJTabbedPane.class, "getTabLayoutPolicy", "setTabLayoutPolicy" ); // NOI18N
            properties[PROPERTY_tabPlacement] = new PropertyDescriptor ( "tabPlacement", comps.tabbedpane.GMPJTabbedPane.class, "getTabPlacement", "setTabPlacement" ); // NOI18N
            properties[PROPERTY_tabRunCount] = new PropertyDescriptor ( "tabRunCount", comps.tabbedpane.GMPJTabbedPane.class, "getTabRunCount", null ); // NOI18N
            properties[PROPERTY_titleAt] = new IndexedPropertyDescriptor ( "titleAt", comps.tabbedpane.GMPJTabbedPane.class, null, null, "getTitleAt", "setTitleAt" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", comps.tabbedpane.GMPJTabbedPane.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", comps.tabbedpane.GMPJTabbedPane.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_toolTipTextAt] = new IndexedPropertyDescriptor ( "toolTipTextAt", comps.tabbedpane.GMPJTabbedPane.class, null, null, "getToolTipTextAt", "setToolTipTextAt" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", comps.tabbedpane.GMPJTabbedPane.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", comps.tabbedpane.GMPJTabbedPane.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", comps.tabbedpane.GMPJTabbedPane.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", comps.tabbedpane.GMPJTabbedPane.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", comps.tabbedpane.GMPJTabbedPane.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", comps.tabbedpane.GMPJTabbedPane.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", comps.tabbedpane.GMPJTabbedPane.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", comps.tabbedpane.GMPJTabbedPane.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", comps.tabbedpane.GMPJTabbedPane.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", comps.tabbedpane.GMPJTabbedPane.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", comps.tabbedpane.GMPJTabbedPane.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", comps.tabbedpane.GMPJTabbedPane.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", comps.tabbedpane.GMPJTabbedPane.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", comps.tabbedpane.GMPJTabbedPane.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( comps.tabbedpane.GMPJTabbedPane.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_changeListener] = new EventSetDescriptor ( comps.tabbedpane.GMPJTabbedPane.class, "changeListener", javax.swing.event.ChangeListener.class, new String[] {"stateChanged"}, "addChangeListener", "removeChangeListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( comps.tabbedpane.GMPJTabbedPane.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( comps.tabbedpane.GMPJTabbedPane.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( comps.tabbedpane.GMPJTabbedPane.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( comps.tabbedpane.GMPJTabbedPane.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( comps.tabbedpane.GMPJTabbedPane.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( comps.tabbedpane.GMPJTabbedPane.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( comps.tabbedpane.GMPJTabbedPane.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( comps.tabbedpane.GMPJTabbedPane.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( comps.tabbedpane.GMPJTabbedPane.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( comps.tabbedpane.GMPJTabbedPane.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( comps.tabbedpane.GMPJTabbedPane.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( comps.tabbedpane.GMPJTabbedPane.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_addClosableTab7] = new MethodDescriptor(comps.tabbedpane.GMPJTabbedPane.class.getMethod("addClosableTab", new Class[] {java.lang.String.class, javax.swing.Icon.class, java.awt.Component.class, java.lang.String.class})); // NOI18N
            ...
            methods[METHOD_getComponentTabIndex50] = new MethodDescriptor(comps.tabbedpane.GMPJTabbedPane.class.getMethod("getComponentTabIndex", new Class[] {java.awt.Component.class})); // NOI18N
            ...
            methods[METHOD_removeTab124] = new MethodDescriptor(comps.tabbedpane.GMPJTabbedPane.class.getMethod("removeTab", new Class[] {java.awt.event.MouseEvent.class})); // NOI18N
